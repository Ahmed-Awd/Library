...
class OrderReadyToTakeawayFromDriver extends Notification
{
    use Queueable;
    ...
    public function toOneSignal($notifiable)
    {
        ...
        $type = "OrderReadyToTakeawayFromDriver";
        $url = $this->order->id;

        return OneSignalMessage::create()
            ->setSubject(Lang::get(
                'messages.notifications.order_ready_to_takeaway_from_driver',
