...
;
class Restaurant_4_FromJosnSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $json_restaurant = file_get_contents(url('database/newest/Restaurant_4.json'));
        ...
        foreach ($restaurant_olds as $restaurant_old) {
            ...
            $restaurant_new = Restaurant::create([
                ...
                'owner_id' =>$user->id ,//we will need check here
