...
define('DOWNLOAD_LINK_YEARGRADE_IMPORT_EXCEL', PREFIX.'downloads/excel-templates/year_grade_template.xlsx');
...
define('URL_ACADEMICS_SEMESTER', PREFIX.'academic-courses/get-academic-semester');
...
//MASTER SETTINGS SET NEW DATA FOR NEW YEAR
define('URL_MASTERSETTINGS_TRANSFERDATA', PREFIX.'mastersettings/transfer-data');
define('URL_MASTERSETTINGS_TRANSFER_ACADEMIC_COURSE', PREFIX.'mastersettings/transfer-data/academic_course');
define('URL_MASTERSETTINGS_TRANSFER_COURSE_SUBJECT', PREFIX.'mastersettings/transfer-data/course_subject');
define('URL_MASTERSETTINGS_TRANSFER_TOPICS', PREFIX.'mastersettings/transfer-data/topics');
define('URL_MASTERSETTINGS_TRANSFER_QUESTIONBANK', PREFIX.'mastersettings/transfer-data/questionbank');
define('URL_MASTERSETTINGS_TRANSFER_LMSCONTENTS', PREFIX.'mastersettings/transfer-data/lmscontent');
...
define('URL_USERS_SWITCH_TEACHER', PREFIX.'users/switchTeacher/');
