...
<div id="page-wrapper">
					...
					<div class="col-md-3">
						...
						<h4 class="card-title">
							<i class="fa fa-certificate"></i>
								...
								<p class="card-text">{{ getPhrase('academic_dues')}}</p>
							</div>
							<a class="card-footer text-muted"
         ...
         <div class="col-md-3">
					...
					<div class="col-md-3">
						<div class="card card-blue text-xs-center helper_step6">
							<div class="card-block">
					  <h4 class="card-title">
					...
					<div class="col-md-3">
						<div class="card card-green text-xs-center helper_step7">
							...
							<h4 class="card-title">
								...
								<p class="card-text">{{ getPhrase('student_list')}}</p>
							</div>
							<a class="card-footer text-muted"
					...
					<div class="col-md-3">
						<div class="card card-red text-xs-center helper_step8">
							...
							<h4 class="card-title">
								...
								<p class="card-text">{{ getPhrase('students_completed_list')}}</p>
							</div>
							<a class="card-footer text-muted"
					...
					<div class="col-md-3">
						<div class="card card-yellow text-xs-center helper_step9">
							...
							<h4 class="card-title">
								...
								<p class="card-text">{{ getPhrase('students_detained_list')}}</p>
							</div>
							<a class="card-footer text-muted"
