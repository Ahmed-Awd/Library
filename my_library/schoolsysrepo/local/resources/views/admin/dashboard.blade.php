...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		<!-- /.container-fluid -->
		<div class="row">
			<?php $latest_students = App\User::getLatestUsersDashboard('student',12);?>

			<div class="col-md-12 helper_step9">
				<!-- USERS LIST -->
				...
				<?php $latest_staff = App\User::getLatestUsersDashboard('staff',12);?>
				<div class="col-md-12 helper_step10">
					<!-- USERS LIST -->
					<div class="panel panel-primary">
						<div class="panel-heading" >
				...
				$offline_payments = App\Payment::latestPayments('offline',5);
				?>
