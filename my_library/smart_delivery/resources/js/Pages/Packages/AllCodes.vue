                            ...
                            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tr v-for="code in codes.data" :key="code.id">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap" v-if="code.package.type == 'driver'">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            {{ __(code.package.type) }}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span v-if="code.purchased_at != null">{{
                                                    processDate(code.purchased_at)
                                                }}</span>
                                        </td>
                                    </tr>
                                    </tbody>
...
export default {
    ...
    data() {
        return {
            ...
            selectedUserType: this.route().params.userType ? this.route().params.userType : 'all',
            ...
            userTypes: [
                {'name': this.__('all'), 'value': "all"},
                {'name': this.__('driver'), 'value': "driver"},
                {'name': this.__('owner'), 'value': "owner"},
            ],
            showDateModal: false,
            dateFrom: null,
            dateTo: null,
    ...
    methods: {
        ...
        submitSearch() {
            ...
            this.form.userType = this.selectedUserType;
            console.log(this.form);
            this.form.get(this.route('packages.codes.all'));
        },
        processDate(date) {
