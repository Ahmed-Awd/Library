            ...
            <div class="max-w-7xl mx-auto">
                <div class="w-1/2 flex items-center w-full justify-between pb-3">
                    <form class="w-100 flex items-center">
                        <div>
                            <jet-label for="start_date" :value="__('Search')"/>
                            <jet-input type="text" class="mt-1 block mr-2" v-model="serverParams.filter" :placeholder="__('Store')"/>
                        </div>
                        <div>
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200" v-else>
                                            <tr v-for="(order, key) in orders" :key="order.id">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="text-sm text-gray-500"> {{order.taken_from_percentage}} %</div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="text-sm text-gray-500"> {{order.orders_sum_delivery_price / 100 }}</div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="text-sm text-gray-500"> {{order.orders_sum_total_price / 100 }}</div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
...
export default {
    ...
    data() {
        return {
            ...
            orders: [],
            dataLoading: false,
            xls_url:"/exports/of/all/stores/",
        };
    },
    methods:{
        filter() {
            this.dataLoading = true;
            axios.get(`/reports/of/all/stores`,{
            ...
            this.xls_url = '/exports/of/all/stores/';
